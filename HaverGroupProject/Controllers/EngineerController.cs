...
namespace HaverGroupProject.Controllers
{
    ...
    public class EngineerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,EngFirstName,EngMiddleName,EngLastName,EngPhone,EngEmail")] Engineer engineer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,EngFirstName,EngMiddleName,EngLastName,EngPhone,EngEmail")] Engineer engineer)
        {
            if (id != engineer.ID)
            {
                return NotFound();
